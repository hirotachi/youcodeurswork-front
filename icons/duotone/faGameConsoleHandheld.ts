...
const faGameConsoleHandheld: IconDefinition = {
  prefix: "fas",
  ...
  icon: [
    ...
    [
      ...
      "M112 224a16 16 0 0 1-16-16V80a16 16 0 0 1 16-16h160a16 16 0 0 1 16 16v112a32 32 0 0 1-32 32z",
    ],
  ],
};
export default faGameConsoleHandheld;
