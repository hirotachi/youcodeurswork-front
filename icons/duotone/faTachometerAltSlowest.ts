...
const faTachometerAltSlowest: IconDefinition = {
  prefix: "fas",
  ...
  icon: [
    ...
    [
      ...
      "M72.33 348.05A24 24 0 0 1 100 328.33l133.68 22.28A63.77 63.77 0 0 1 343.12 416H232.88a65.78 65.78 0 0 1-6.9-18L92.05 375.67a24 24 0 0 1-19.72-27.62z",
    ],
  ],
};
export default faTachometerAltSlowest;
