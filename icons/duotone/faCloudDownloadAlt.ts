...
const faCloudDownloadAlt: IconDefinition = {
	...
	icon: [
		...
		[
			...
			'M404.7 315.3L299.3 420.7a16.06 16.06 0 0 1-22.6 0L171.3 315.3c-10.1-10.1-2.9-27.3 11.3-27.3H248V176a16 16 0 0 1 16-16h48a16 16 0 0 1 16 16v112h65.4c14.2 0 21.4 17.2 11.3 27.3z',
		],
	],
};
export default faCloudDownloadAlt;
