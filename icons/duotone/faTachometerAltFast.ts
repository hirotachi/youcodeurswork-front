...
const faTachometerAltFast: IconDefinition = {
  prefix: "fas",
  ...
  icon: [
    ...
    [
      ...
      "M288 320a63.14 63.14 0 0 1 16.24 2.34L412.8 177.59a24 24 0 1 1 38.41 28.81L342.65 351.14a62.26 62.26 0 0 1 .47 64.86H232.88a63.33 63.33 0 0 1-8.88-32 64 64 0 0 1 64-64z",
    ],
  ],
};
export default faTachometerAltFast;
